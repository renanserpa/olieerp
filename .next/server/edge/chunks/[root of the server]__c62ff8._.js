(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__c62ff8._.js", {
...
{
__turbopack_esm__({
    "createSupabaseMiddlewareClient": (()=>createSupabaseMiddlewareClient)
});
...
;
;
async function createSupabaseMiddlewareClient(req) {
...
async function middleware(request) {
    try {
        const { supabase, response } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$middleware$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["createSupabaseMiddlewareClient"])(request);
        ...
        if (session && request.nextUrl.pathname.startsWith("/login")) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", request.url)); // Redirect to dashboard root
        }
        return response;
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c62ff8._.js.map